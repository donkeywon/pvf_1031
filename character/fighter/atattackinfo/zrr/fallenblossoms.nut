...
//update
        ...
        if(skill_level2 > 0)
        {
            ...
            sq_SetChangeStatusIntoAttackInfo(attackInfo, 0, ACTIVESTATUS_FREEZE,  sq_GetLevelData(obj, SKILL_FALLENBLOSSOMS, 2, skillLevel),  sq_GetLevelData(obj, SKILL_FALLENBLOSSOMS, 3, skillLevel) + sq_GetLevelData(obj, SKILL_ICEMASTER , 1, skill_level2),  sq_GetLevelData(obj, SKILL_FALLENBLOSSOMS, 4, skillLevel));
