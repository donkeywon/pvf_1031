...
[use animation]
	`../Effect/Animation/ElbowThrow/LOOP_SPIN_01_swing_up_d.ani`
	`LOOP_SPIN_01_swing_up_d`

[use animation]
	`../Effect/Animation/ElbowThrow/LOOP_SPIN_speed_d.ani`
	`LOOP_SPIN_speed_d`

[use animation]
	`../Effect/Animation/ElbowThrow/LOOP_SPIN_01_swing_down_d.ani`
