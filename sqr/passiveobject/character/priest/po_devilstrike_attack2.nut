...
function setCustomData_po_DevilStrike2(obj,reciveData)
{
...
function setState_po_DevilStrike2(obj, state, datas)
{
}

function procAppend_po_DevilStrike2(obj)
{
...
function onDestroyObject_po_DevilStrike2(obj, object)
{
}
