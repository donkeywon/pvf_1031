...
{
	appendage.sq_AddFunctionName("proc", "proc_appendage_atgunner_huashi")
	appendage.sq_AddFunctionName("onStart", "onStart_appendage_atgunner_huashi")
}
...
function onStart_appendage_atgunner_huashi(appendage)
{
	if(!appendage) return;
	...
	local value0 = sq_GetLevelData(obj, SKILL_ATGUNNER_HUASHI, 4, skill_level);
	local value1 = sq_GetLevelData(obj, SKILL_ATGUNNER_HUASHI, 5, skill_level);
	local change_appendage = appendage.sq_getChangeStatus("atgunner_huashi");
	...
	if(change_appendage)
	{
		...
		value0 = value0*10*STATE_ATGUNNER_HUASHI;
		...
		value1 = value1/10*STATE_ATGUNNER_HUASHI;
...
function proc_appendage_atgunner_huashi(appendage)
{
	if(!appendage) return;
}
