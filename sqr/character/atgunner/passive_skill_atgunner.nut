...
function ProcPassiveSkill_ATGunner(NfDEvwlcEC_mxO, vplKviQdJmi, ExhprNt6s8aDvIWa)
{
 switch(vplKviQdJmi)
 {
 case 250: 
 local EuZEQchhIO2g1V2 = CNSquirrelAppendage.sq_AppendAppendage(NfDEvwlcEC_mxO, NfDEvwlcEC_mxO, vplKviQdJmi, false, "character/atgunner/appendage/ap_stylish_buff.nut", true);
 local FC1eWFWuEDiMU = NfDEvwlcEC_mxO.sq_GetLevelData(vplKviQdJmi, 2, ExhprNt6s8aDvIWa); 
 local LUy0opgJNM0Xbu = NfDEvwlcEC_mxO.sq_GetLevelData(vplKviQdJmi, 3, ExhprNt6s8aDvIWa); 
