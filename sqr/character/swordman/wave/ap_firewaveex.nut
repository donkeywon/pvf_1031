...
{
	appendage.sq_AddFunctionName("proc", "proc_appendage_firewaveex")
	appendage.sq_AddFunctionName("onStart", "onStart_appendage_firewaveex")
	appendage.sq_AddFunctionName("onEnd", "onEnd_appendage_firewaveex")
}
...
function proc_appendage_firewaveex(appendage)
{
...
function onStart_appendage_firewaveex(appendage)
{
...
function onEnd_appendage_firewaveex(appendage)
{
	if(!appendage)
	{
		return;
