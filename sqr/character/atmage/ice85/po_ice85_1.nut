function setCustomData_po_breakice_frist(obj, receiveData)
{
	if(!obj)
		return;
...
function procAppend_po_breakice_frist(obj)
{
...
function onEndCurrentAni_po_breakice_frist(obj)
{
        if(!obj.isMyControlObject()) {
            return;
        }
    ...
    sq_SendCreatePassiveObjectPacketPos(obj, 24360, 0, x, y, z);

    sq_SendDestroyPacketPassiveObject(obj);	

}

function onAttack_po_breakice_frist(obj, damager, boundingBox, isStuck)
{
