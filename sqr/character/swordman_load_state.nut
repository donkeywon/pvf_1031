...
IRDSQRCharacter.pushState(ENUM_CHARACTERJOB_SWORDMAN, "character/swordman/flowmind/flowmindone.nut", "swordman_flowmindone", 62, -1);
IRDSQRCharacter.pushState(ENUM_CHARACTERJOB_SWORDMAN, "character/swordman/flowmind/flowmindtwo.nut", "swordman_flowmindtwo", 63, -1);
IRDSQRCharacter.pushState(ENUM_CHARACTERJOB_SWORDMAN, "character/swordman/flowmind/flowmindthree.nut", "swordman_flowmindthree", 64, -1);
...
IRDSQRCharacter.pushState(ENUM_CHARACTERJOB_SWORDMAN, "character/swordman/Standalonewave/Standalonewave.nut", "swordman_standalonewave", 34, -1);
...
IRDSQRCharacter.pushState(ENUM_CHARACTERJOB_SWORDMAN, "Character/Swordman/LeiShen/JianQi.nut", "SwordmanAttack", 8, -1);