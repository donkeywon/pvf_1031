...
IRDSQRCharacter.pushState(ENUM_CHARACTERJOB_GUNNER, "character/gunner/seventhflow/seventhflow.nut", "gunner_seventhflow", 240, 240);
...
IRDSQRCharacter.pushState(ENUM_CHARACTERJOB_GUNNER, "character/gunner/windmill/stylishbackstepheadshot.nut", "step_headshot", 169, -1);
