function setCustomData_po_qq506807329new_mage_24372(LUiM_0hXlChfq, XDK8M9SqpuVMB4UpE0ZQA) {
	...
	case 242:
		...
		if (LUiM_0hXlChfq.isMyControlObject()) LUiM_0hXlChfq.addSetStatePacket(10, sq_GetGlobalIntVector(), STATE_PRIORITY_AUTO, false, "");
		break;
	case 55:
		local CQiDlE1ooNLkXEvq = XDK8M9SqpuVMB4UpE0ZQA.readDword();
		switch (CQiDlE1ooNLkXEvq) {
		case 0:
			local CQ1oLLDb8fm7HfYbkL = XDK8M9SqpuVMB4UpE0ZQA.readDword();
			local CQUqQ8WMQyMBCIY = XDK8M9SqpuVMB4UpE0ZQA.readDword();
			local CQHlLYlDGVyHJncmy = XDK8M9SqpuVMB4UpE0ZQA.readDword();
			local CQj9qi3tcx8sSC = XDK8M9SqpuVMB4UpE0ZQA.readDword();
			local CQEN3JFdsrsOsqew = XDK8M9SqpuVMB4UpE0ZQA.readDword();
			LUiM_0hXlChfq.getVar().clear_vector();
			LUiM_0hXlChfq.getVar().push_vector(CQUqQ8WMQyMBCIY);
			LUiM_0hXlChfq.getVar().push_vector(CQHlLYlDGVyHJncmy);
			LUiM_0hXlChfq.getVar().push_vector(CQj9qi3tcx8sSC);
			LUiM_0hXlChfq.getVar().push_vector(CQEN3JFdsrsOsqew);
			local CQ3Mp5vVgXjuF9wiV = sq_GetCustomAttackInfo(LUiM_0hXlChfq, 29);
			sq_SetCurrentAttackBonusRate(CQ3Mp5vVgXjuF9wiV, CQ1oLLDb8fm7HfYbkL);
			sq_SetCurrentAttackInfo(LUiM_0hXlChfq, CQ3Mp5vVgXjuF9wiV);
			LUiM_0hXlChfq.addSetStatePacket(10, sq_GetGlobalIntVector(), STATE_PRIORITY_AUTO, false, "");
			break;
		case 1:
			LUiM_0hXlChfq.addSetStatePacket(11, sq_GetGlobalIntVector(), STATE_PRIORITY_AUTO, false, "");
			break;
		}
		break;
	case 58:
		...
		case 0:
			local CQ1oLLDb8fm7HfYbkL = XDK8M9SqpuVMB4UpE0ZQA.readDword();
			local CQTebFp7UKC9POqudl = XDK8M9SqpuVMB4UpE0ZQA.readDword();
			local CQj9qi3tcx8sSC = XDK8M9SqpuVMB4UpE0ZQA.readDword();
			local CQ6fbldw7p4KyVmoQ = XDK8M9SqpuVMB4UpE0ZQA.readDword();
			local CQEN3JFdsrsOsqew = XDK8M9SqpuVMB4UpE0ZQA.readDword();
			local CQXJySwLBgfuufna = XDK8M9SqpuVMB4UpE0ZQA.readDword();
			LUiM_0hXlChfq.getVar().clear_vector();
			LUiM_0hXlChfq.getVar().push_vector(CQ1oLLDb8fm7HfYbkL);
			LUiM_0hXlChfq.getVar().push_vector(CQTebFp7UKC9POqudl);
			LUiM_0hXlChfq.getVar().push_vector(CQj9qi3tcx8sSC);
			LUiM_0hXlChfq.getVar().push_vector(CQ6fbldw7p4KyVmoQ);
			LUiM_0hXlChfq.getVar().push_vector(CQEN3JFdsrsOsqew);
			LUiM_0hXlChfq.getVar().push_vector(CQXJySwLBgfuufna);
			local CQ3Mp5vVgXjuF9wiV = sq_GetCustomAttackInfo(LUiM_0hXlChfq, 27);
			sq_SetCurrentAttackBonusRate(CQ3Mp5vVgXjuF9wiV, CQ1oLLDb8fm7HfYbkL);
			sq_SetCurrentAttackInfo(LUiM_0hXlChfq, CQ3Mp5vVgXjuF9wiV);
			LUiM_0hXlChfq.addSetStatePacket(10, sq_GetGlobalIntVector(), STATE_PRIORITY_AUTO, false, "");
			break;
	...
	case 27:
		...
		case 0:
			local CQ1oLLDb8fm7HfYbkL = XDK8M9SqpuVMB4UpE0ZQA.readDword();
			local CQTebFp7UKC9POqudl = XDK8M9SqpuVMB4UpE0ZQA.readDword();
			local CQD2wBki3VNKWBWIz5 = XDK8M9SqpuVMB4UpE0ZQA.readFloat();
			local CQRLZgHgbxWPqaW = XDK8M9SqpuVMB4UpE0ZQA.readFloat();
			local CQiOwmuMXr7uvRrAq = sq_GetDistancePos(LUiM_0hXlChfq.getXPos(), LUiM_0hXlChfq.getDirection(), 500);
			LUiM_0hXlChfq.getVar().clear_vector();
			LUiM_0hXlChfq.getVar().push_vector(CQ1oLLDb8fm7HfYbkL);
			LUiM_0hXlChfq.getVar().push_vector(CQTebFp7UKC9POqudl);
			LUiM_0hXlChfq.getVar().push_vector(CQiOwmuMXr7uvRrAq);
			LUiM_0hXlChfq.getVar().setFloat(0, CQD2wBki3VNKWBWIz5);
			LUiM_0hXlChfq.getVar().setFloat(1, CQRLZgHgbxWPqaW);
			local CQ3Mp5vVgXjuF9wiV = sq_GetCustomAttackInfo(LUiM_0hXlChfq, 25);
			sq_SetCurrentAttackBonusRate(CQ3Mp5vVgXjuF9wiV, CQ1oLLDb8fm7HfYbkL);
			sq_SetCurrentAttackInfo(LUiM_0hXlChfq, CQ3Mp5vVgXjuF9wiV);
			LUiM_0hXlChfq.addSetStatePacket(10, sq_GetGlobalIntVector(), STATE_PRIORITY_AUTO, false, "");
			break;
	...
	case 59:
		...
		switch (CQiDlE1ooNLkXEvq) {
		case 0:
			local CQHnjdKd8aDczCwPH6 = XDK8M9SqpuVMB4UpE0ZQA.readDword();
			local CQEN3JFdsrsOsqew = XDK8M9SqpuVMB4UpE0ZQA.readDword();
			local CQE5UpRWNjX4xNQDN = XDK8M9SqpuVMB4UpE0ZQA.readDword();
			local CQ4XHLVxxpQXjs = XDK8M9SqpuVMB4UpE0ZQA.readDword();
			local CQQAU8IXa12SdgmH = XDK8M9SqpuVMB4UpE0ZQA.readDword();
			local CQLuMYqIRgupkPmVYT = XDK8M9SqpuVMB4UpE0ZQA.readDword();
			local CQ6fbldw7p4KyVmoQ = XDK8M9SqpuVMB4UpE0ZQA.readDword();
			LUiM_0hXlChfq.getVar().clear_vector();
			LUiM_0hXlChfq.getVar().push_vector(CQEN3JFdsrsOsqew);
			LUiM_0hXlChfq.getVar().push_vector(CQE5UpRWNjX4xNQDN);
			LUiM_0hXlChfq.getVar().push_vector(CQHnjdKd8aDczCwPH6);
			LUiM_0hXlChfq.getVar().push_vector(CQ4XHLVxxpQXjs);
			LUiM_0hXlChfq.getVar().push_vector(CQQAU8IXa12SdgmH);
			LUiM_0hXlChfq.getVar().push_vector(CQLuMYqIRgupkPmVYT);
			LUiM_0hXlChfq.getVar().push_vector(CQ6fbldw7p4KyVmoQ);
			local CQ3Mp5vVgXjuF9wiV = sq_GetCustomAttackInfo(LUiM_0hXlChfq, 23);
			sq_SetCurrentAttackBonusRate(CQ3Mp5vVgXjuF9wiV, CQHnjdKd8aDczCwPH6);
			sq_SetCurrentAttackInfo(LUiM_0hXlChfq, CQ3Mp5vVgXjuF9wiV);
			LUiM_0hXlChfq.addSetStatePacket(10, sq_GetGlobalIntVector(), STATE_PRIORITY_AUTO, false, "");
			break;
		case 1:
			...
			sq_SetCurrentAttackBonusRate(CQ3Mp5vVgXjuF9wiV, CQHnjdKd8aDczCwPH6);
			sq_SetCurrentAttackInfo(LUiM_0hXlChfq, CQ3Mp5vVgXjuF9wiV);
			LUiM_0hXlChfq.addSetStatePacket(20, sq_GetGlobalIntVector(), STATE_PRIORITY_AUTO, false, "");
			break;
		case 2:
			LUiM_0hXlChfq.addSetStatePacket(21, sq_GetGlobalIntVector(), STATE_PRIORITY_AUTO, false, "");
			break;
		}
		break;
	case 245:
