function setState_po_qq506807329new_mage_24372(dKqt8L7ZvgyB, QME3kfKOCzou, lbNq4j7HjAgxvbvbVNWDo) {
	...
	case 249:
		...
		case 10:
			...
			if (dKqt8L7ZvgyB.isMyControlObject()) sq_flashScreen(dKqt8L7ZvgyB, 720, 0, 200, 51, sq_RGB(0, 0, 0), GRAPHICEFFECT_NONE, ENUM_DRAWLAYER_BOTTOM);
			break;
		}
		break;
	case 55:
		switch (QME3kfKOCzou) {
		case 10:
			local CQCsQT2wTGpZxZYN = "passiveobject/character/mage/animation/elementalpotential/thunderstrike/epthunderstrike_lightning01.ani";
			local CQcr4rD5FRRAjUYXCL = sq_CreateAnimation("", CQCsQT2wTGpZxZYN);
			dKqt8L7ZvgyB.setCurrentAnimation(CQcr4rD5FRRAjUYXCL);

			local CQAYpAWK9bAidVc = dKqt8L7ZvgyB.getVar().get_vector(3) / 2;
			local CQdRhMlEwDzQkEeBj = dKqt8L7ZvgyB.getObjectManager();
			for (local CQy2GjLj1dLxff = 0; CQy2GjLj1dLxff < CQdRhMlEwDzQkEeBj.getCollisionObjectNumber(); ++CQy2GjLj1dLxff) {
				local CQNKnQp2YWmf6IwM = CQdRhMlEwDzQkEeBj.getCollisionObject(CQy2GjLj1dLxff);
				local CQbIGObpsPM3RnQCp5 = sq_GetDistanceObject(dKqt8L7ZvgyB, CQNKnQp2YWmf6IwM, false);
				if (CQNKnQp2YWmf6IwM && dKqt8L7ZvgyB.isEnemy(CQNKnQp2YWmf6IwM) && CQbIGObpsPM3RnQCp5 <= CQAYpAWK9bAidVc && CQNKnQp2YWmf6IwM.isObjectType(OBJECTTYPE_ACTIVE)) {
					local CQoWbV9ng8tZ7XQ3I = "character/mage/element/ap_2.nut";
					local CQ2vNRZRte7A2m = CNSquirrelAppendage.sq_IsAppendAppendage(CQNKnQp2YWmf6IwM, CQoWbV9ng8tZ7XQ3I);
					if (!CQ2vNRZRte7A2m) {
						local CQmgymEFZLsF8Bm6 = CNSquirrelAppendage.sq_AppendAppendage(CQNKnQp2YWmf6IwM, dKqt8L7ZvgyB, -1, false, CQoWbV9ng8tZ7XQ3I, true);
						if (CQmgymEFZLsF8Bm6) {
							CQmgymEFZLsF8Bm6.sq_SetValidTime(180);
							sq_MoveToAppendageForce(CQNKnQp2YWmf6IwM, dKqt8L7ZvgyB, dKqt8L7ZvgyB, 0, 0, CQNKnQp2YWmf6IwM.getZPos(), 110, true, CQmgymEFZLsF8Bm6, true);
						}
					}
				}
			}
			break;
		case 11:
			local CQCsQT2wTGpZxZYN = "passiveobject/character/mage/animation/elementalpotential/thunderstrike/epthunderstrike_hit01.ani";
			local CQcr4rD5FRRAjUYXCL = sq_CreateAnimation("", CQCsQT2wTGpZxZYN);
			dKqt8L7ZvgyB.setCurrentAnimation(CQcr4rD5FRRAjUYXCL);
			break;
		}
	...
	case 58:
		switch (QME3kfKOCzou) {
		case 10:
			local CQCsQT2wTGpZxZYN = "passiveobject/character/mage/animation/nighthollow/elementalpotential/nighthollow2_start_dodge.ani";
			local CQcr4rD5FRRAjUYXCL = sq_CreateAnimation("", CQCsQT2wTGpZxZYN);
			dKqt8L7ZvgyB.setCurrentAnimation(CQcr4rD5FRRAjUYXCL);

			dKqt8L7ZvgyB.getVar("aniobj").clear_obj_vector();
			local CQwuxpkrNUw5ZVb8 = dKqt8L7ZvgyB.getVar("aniobj");
			local CQZUXK18eG3VGQyjiK = "passiveobject/character/mage/animation/nighthollow/elementalpotential/shockwave2_dodge.ani";
			local CQzkw7uXJRiFXdt = sq_CreateAnimation("", CQZUXK18eG3VGQyjiK);
			local CQO65YcsfbdEHsWlP = sq_CreatePooledObject(CQzkw7uXJRiFXdt, false);
			sq_SetCurrentDirection(CQO65YcsfbdEHsWlP, dKqt8L7ZvgyB.getDirection());
			CQO65YcsfbdEHsWlP.setCurrentPos(dKqt8L7ZvgyB.getXPos(), dKqt8L7ZvgyB.getYPos(), 0);
			CQO65YcsfbdEHsWlP = sq_SetEnumDrawLayer(CQO65YcsfbdEHsWlP, ENUM_DRAWLAYER_BOTTOM);
			sq_AddObject(dKqt8L7ZvgyB, CQO65YcsfbdEHsWlP, OBJECTTYPE_DRAWONLY, false);
			CQwuxpkrNUw5ZVb8.push_obj_vector(CQO65YcsfbdEHsWlP);

			break;
		case 11:
			local CQCsQT2wTGpZxZYN = "passiveobject/character/mage/animation/nighthollow/elementalpotential/nighthollow2_loop_dodge.ani";
			local CQcr4rD5FRRAjUYXCL = sq_CreateAnimation("", CQCsQT2wTGpZxZYN);
			dKqt8L7ZvgyB.setCurrentAnimation(CQcr4rD5FRRAjUYXCL);

			local CQViJ5iJyWJhSmeT8L = dKqt8L7ZvgyB.getVar().get_vector(3);
			local CQYmUzYqXPn6sBe = dKqt8L7ZvgyB.getVar().get_vector(2) / CQViJ5iJyWJhSmeT8L;
			dKqt8L7ZvgyB.setTimeEvent(0, CQViJ5iJyWJhSmeT8L, CQYmUzYqXPn6sBe, true);
			break;
		case 12:
			RemoveAllAni(dKqt8L7ZvgyB);
			local CQCsQT2wTGpZxZYN = "passiveobject/character/mage/animation/nighthollow/elementalpotential/nighthollow2_exp_dodge.ani";
			local CQcr4rD5FRRAjUYXCL = sq_CreateAnimation("", CQCsQT2wTGpZxZYN);
			dKqt8L7ZvgyB.setCurrentAnimation(CQcr4rD5FRRAjUYXCL);
			local CQuV12qo8L6apOQY = sq_GetCustomAttackInfo(dKqt8L7ZvgyB, 28);
			sq_SetCurrentAttackBonusRate(CQuV12qo8L6apOQY, dKqt8L7ZvgyB.getVar().get_vector(1));
			sq_SetCurrentAttackInfo(dKqt8L7ZvgyB, CQuV12qo8L6apOQY);
			dKqt8L7ZvgyB.setTimeEvent(1, 180, 1, false);
			break;
		}
		break;
	case 27:
		switch (QME3kfKOCzou) {
		case 10:
			local CQCsQT2wTGpZxZYN = "passiveobject/character/mage/animation/elementalpotential/halloweenbuster/ep_halloweenbusterb_meteor_base01.ani";
			local CQcr4rD5FRRAjUYXCL = sq_CreateAnimation("", CQCsQT2wTGpZxZYN);
			dKqt8L7ZvgyB.setCurrentAnimation(CQcr4rD5FRRAjUYXCL);
			local CQpQSAODcJDnyq = dKqt8L7ZvgyB.getVar().getFloat(0);

			CQcr4rD5FRRAjUYXCL.setImageRateFromOriginal(CQpQSAODcJDnyq, CQpQSAODcJDnyq);
			CQcr4rD5FRRAjUYXCL.setAutoLayerWorkAnimationAddSizeRate(CQpQSAODcJDnyq);
			sq_SetAttackBoundingBoxSizeRate(CQcr4rD5FRRAjUYXCL, CQpQSAODcJDnyq, CQpQSAODcJDnyq, CQpQSAODcJDnyq);
			break;
		case 11:
			local CQCsQT2wTGpZxZYN = "passiveobject/character/mage/animation/elementalpotential/halloweenbuster/ep_halloweenbuster_explosion_04.ani";
			local CQcr4rD5FRRAjUYXCL = sq_CreateAnimation("", CQCsQT2wTGpZxZYN);
			dKqt8L7ZvgyB.setCurrentAnimation(CQcr4rD5FRRAjUYXCL);
			local CQpQSAODcJDnyq = dKqt8L7ZvgyB.getVar().getFloat(1);
			CQcr4rD5FRRAjUYXCL.setImageRateFromOriginal(CQpQSAODcJDnyq, CQpQSAODcJDnyq);
			CQcr4rD5FRRAjUYXCL.setAutoLayerWorkAnimationAddSizeRate(CQpQSAODcJDnyq);
			sq_SetAttackBoundingBoxSizeRate(CQcr4rD5FRRAjUYXCL, CQpQSAODcJDnyq, CQpQSAODcJDnyq, CQpQSAODcJDnyq);
			local CQuV12qo8L6apOQY = sq_GetCustomAttackInfo(dKqt8L7ZvgyB, 26);
			sq_SetCurrentAttackBonusRate(CQuV12qo8L6apOQY, dKqt8L7ZvgyB.getVar().get_vector(1));
			sq_SetCurrentAttackInfo(dKqt8L7ZvgyB, CQuV12qo8L6apOQY);
			if (dKqt8L7ZvgyB.isMyControlObject()) sq_SetMyShake(dKqt8L7ZvgyB, 10, 300);
			break;
		}
		break;
	case 59:
		switch (QME3kfKOCzou) {
		case 10:
			local CQCsQT2wTGpZxZYN = "passiveobject/character/mage/animation/elementalpotential/icearea/field2floorappear.ani";
			local CQcr4rD5FRRAjUYXCL = sq_CreateAnimation("", CQCsQT2wTGpZxZYN);
			dKqt8L7ZvgyB.setCurrentAnimation(CQcr4rD5FRRAjUYXCL);
			local CQpQSAODcJDnyq = 1.3;
			CQcr4rD5FRRAjUYXCL.setSpeedRate(300.0);
			CQcr4rD5FRRAjUYXCL.setImageRateFromOriginal(CQpQSAODcJDnyq, CQpQSAODcJDnyq);
			CQcr4rD5FRRAjUYXCL.setAutoLayerWorkAnimationAddSizeRate(CQpQSAODcJDnyq);
			sq_ChangeDrawLayer(dKqt8L7ZvgyB, ENUM_DRAWLAYER_BOTTOM);
			local CQYmUzYqXPn6sBe = dKqt8L7ZvgyB.getVar().get_vector(1) * 2 + 1;
			local CQViJ5iJyWJhSmeT8L = dKqt8L7ZvgyB.getVar().get_vector(6);

			dKqt8L7ZvgyB.setTimeEvent(0, CQViJ5iJyWJhSmeT8L, CQYmUzYqXPn6sBe, false);
			dKqt8L7ZvgyB.setTimeEvent(1, CQViJ5iJyWJhSmeT8L * (CQYmUzYqXPn6sBe + 3), 1, false);
			break;
		case 11:
			local CQCsQT2wTGpZxZYN = "passiveobject/character/mage/animation/elementalpotential/icearea/field2.ani";
			local CQcr4rD5FRRAjUYXCL = sq_CreateAnimation("", CQCsQT2wTGpZxZYN);
			dKqt8L7ZvgyB.setCurrentAnimation(CQcr4rD5FRRAjUYXCL);
			CQcr4rD5FRRAjUYXCL.setLoop(true);
			local CQpQSAODcJDnyq = 1.3;
			CQcr4rD5FRRAjUYXCL.setImageRateFromOriginal(CQpQSAODcJDnyq, CQpQSAODcJDnyq);
			CQcr4rD5FRRAjUYXCL.setAutoLayerWorkAnimationAddSizeRate(CQpQSAODcJDnyq);
			sq_SetAttackBoundingBoxSizeRate(CQcr4rD5FRRAjUYXCL, CQpQSAODcJDnyq, CQpQSAODcJDnyq, CQpQSAODcJDnyq);
			local CQYmUzYqXPn6sBe = dKqt8L7ZvgyB.getVar().get_vector(1) * 2 + 1;
			local CQViJ5iJyWJhSmeT8L = dKqt8L7ZvgyB.getVar().get_vector(6);
			dKqt8L7ZvgyB.setTimeEvent(2, CQViJ5iJyWJhSmeT8L * 2, CQYmUzYqXPn6sBe / 2 + 3, true);
			break;
		case 12:
			local CQCsQT2wTGpZxZYN = "passiveobject/character/mage/animation/elementalpotential/icearea/field2disappear.ani";
			local CQcr4rD5FRRAjUYXCL = sq_CreateAnimation("", CQCsQT2wTGpZxZYN);
			dKqt8L7ZvgyB.setCurrentAnimation(CQcr4rD5FRRAjUYXCL);
			local CQpQSAODcJDnyq = 1.3;
			CQcr4rD5FRRAjUYXCL.setImageRateFromOriginal(CQpQSAODcJDnyq, CQpQSAODcJDnyq);
			...
			break;
		case 20:
			local CQCsQT2wTGpZxZYN = "passiveobject/character/mage/animation/icefireexplosion.ani";
			local CQcr4rD5FRRAjUYXCL = sq_CreateAnimation("", CQCsQT2wTGpZxZYN);
			dKqt8L7ZvgyB.setCurrentAnimation(CQcr4rD5FRRAjUYXCL);
			break;
		case 21:
			local CQCsQT2wTGpZxZYN = "passiveobject/character/mage/animation/elementalpotential/icearea/icearea_att_3.ani";
			local CQcr4rD5FRRAjUYXCL = sq_CreateAnimation("", CQCsQT2wTGpZxZYN);
			dKqt8L7ZvgyB.setCurrentAnimation(CQcr4rD5FRRAjUYXCL);
			break;
		case 22:
			local CQCsQT2wTGpZxZYN = "passiveobject/character/mage/animation/icefieldnormal2.ani";
			local CQcr4rD5FRRAjUYXCL = sq_CreateAnimation("", CQCsQT2wTGpZxZYN);
			dKqt8L7ZvgyB.setCurrentAnimation(CQcr4rD5FRRAjUYXCL);
			break;
		}
	...
	case 242:
		...
		case 12:
			...
			for (local dJtWGZD1GzN = 0; dJtWGZD1GzN < 8; dJtWGZD1GzN++) {
				...
				if (R2X8krKn2CD1) R2X8krKn2CD1.setValid(false);
			}
	...
	case 251:
		local dtmCKaqMvIx = (dKqt8L7ZvgyB.getVar().get_vector(0)).tofloat() / 100.0;
		if (QME3kfKOCzou < 14) {
			local Xiy54ye7MQB = ["character/mage/effect/animation/crystalofovermind/groweffect/crystalofovermind_grow01_start.ani", "character/mage/effect/animation/crystalofovermind/groweffect/crystalofovermind_grow02_start.ani", "character/mage/effect/animation/crystalofovermind/groweffect/crystalofovermind_grow03_start.ani", "character/mage/effect/animation/crystalofovermind/groweffect/crystalofovermind_grow04_start.ani", "character/mage/effect/animation/crystalofovermind/groweffect/crystalofovermind_grow04_start_back.ani"];
			local a3EygYW_g9T1s9M7D1FBA1E4 = ["passiveobject/script_sqr_nut_qq506807329/mage/animation/crystalofovermind/crystalofovermind_grow01_loop.ani", "passiveobject/script_sqr_nut_qq506807329/mage/animation/crystalofovermind/crystalofovermind_grow02_loop.ani", "passiveobject/script_sqr_nut_qq506807329/mage/animation/crystalofovermind/crystalofovermind_grow03_loop.ani", "passiveobject/script_sqr_nut_qq506807329/mage/animation/crystalofovermind/crystalofovermind_grow04_loop.ani"];
			local cTnfR1MZO2GJgngLVmc = sq_CreateAnimation("", Xiy54ye7MQB[QME3kfKOCzou - 10]);
			if (QME3kfKOCzou != 13) cTnfR1MZO2GJgngLVmc.addLayerAnimation(-1, sq_CreateAnimation("", a3EygYW_g9T1s9M7D1FBA1E4[QME3kfKOCzou - 10]), true);
			else cTnfR1MZO2GJgngLVmc.addLayerAnimation(-1, sq_CreateAnimation("", Xiy54ye7MQB[QME3kfKOCzou - 10 + 1]), true);
			cTnfR1MZO2GJgngLVmc.setImageRateFromOriginal(dtmCKaqMvIx, dtmCKaqMvIx);
			cTnfR1MZO2GJgngLVmc.setAutoLayerWorkAnimationAddSizeRate(dtmCKaqMvIx);
			dKqt8L7ZvgyB.setCurrentAnimation(cTnfR1MZO2GJgngLVmc);
	...
	case 252:
		...
		case 1:
			...
			switch (QME3kfKOCzou) {
			case 10:
				PXJWl_9Eg8wDNjWaU1wNm = "start";
				break;
			case 11:
				PXJWl_9Eg8wDNjWaU1wNm = "loop";
				break;
			case 12:
				PXJWl_9Eg8wDNjWaU1wNm = "end";
				break;
			}
			local Xiy54ye7MQB = ["fire/" + PXJWl_9Eg8wDNjWaU1wNm + "/fire_magic.ani", "ice/" + PXJWl_9Eg8wDNjWaU1wNm + "/ice_magic.ani", "dark/" + PXJWl_9Eg8wDNjWaU1wNm + "/dark_magic.ani", "light/" + PXJWl_9Eg8wDNjWaU1wNm + "/light_magic.ani"];
		...
		case 1:
			...
			case 10:
				...
				for (local dJtWGZD1GzN = 0; dJtWGZD1GzN < tgqVCNChB5aR9pmQC2eH.getCollisionObjectNumber(); dJtWGZD1GzN++) {
					...
					if (OOdRrbNiXTLlJrwkpp5Ir && OOdRrbNiXTLlJrwkpp5Ir.isObjectType(OBJECTTYPE_ACTIVE) && dKqt8L7ZvgyB.isEnemy(OOdRrbNiXTLlJrwkpp5Ir) && OOdRrbNiXTLlJrwkpp5Ir.isInDamagableState(dKqt8L7ZvgyB)) {
						...
						if (B4dkE1vFVArFuaJr9lAUws && !B4dkE1vFVArFuaJr9lAUws.isDead()) {
							...
							if (sq_Abs(B4dkE1vFVArFuaJr9lAUws.getXPos() - heDN_uCkB17J9201rg) <= mGhfDT2Non && sq_Abs(B4dkE1vFVArFuaJr9lAUws.getYPos() - MRP4slDbuWo9SNG) <= Ovf0xAmRD3mglok0Z && sq_Abs(B4dkE1vFVArFuaJr9lAUws.getZPos() - oJ8oMWZ9bIm7AnU) <= DMmRanRx2EbFq0j7rT9) {
								if (sq_IsGrabable(dKqt8L7ZvgyB, B4dkE1vFVArFuaJr9lAUws) && sq_IsHoldable(dKqt8L7ZvgyB, B4dkE1vFVArFuaJr9lAUws) && !sq_IsFixture(B4dkE1vFVArFuaJr9lAUws) && !CNSquirrelAppendage.sq_IsAppendAppendage(B4dkE1vFVArFuaJr9lAUws, "character/mage/jackfrosticewater/ap_jackfrosticewater.nut")) {
			...
			case 12:
				...
				local iXHGSUQMh6Hk8CQXP3V = dKqt8L7ZvgyB.getVar("aniobj");
				local UUaHkoJEYxKeD = iXHGSUQMh6Hk8CQXP3V.get_obj_vector_size();
				local Xiy54ye7MQB = ["character/mage/effect/animation/jackfrosticewater/end/jackfrosticewaterendfloortwister_01.ani", "character/mage/effect/animation/jackfrosticewater/end/jackfrosticewaterendfloor_01.ani", "character/mage/effect/animation/jackfrosticewater/end/jackfrosticewaterendfront_10.ani"];
				for (local dJtWGZD1GzN = 0; dJtWGZD1GzN < UUaHkoJEYxKeD; dJtWGZD1GzN++) {
					local UBvODlra6dvb70BE = iXHGSUQMh6Hk8CQXP3V.get_obj_vector(dJtWGZD1GzN);
					if (UBvODlra6dvb70BE) UBvODlra6dvb70BE.setCurrentAnimation(sq_CreateAnimation("", Xiy54ye7MQB[dJtWGZD1GzN]));
				}
				break;
			}
			break;
