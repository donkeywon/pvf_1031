...
function setCustomData_po_qq506807329new_priest_24374(RQUG25JPpq2qN, wBGU4gk7_tNAq9biq) {
	...
	case 237:
		...
		case 1:
			...
			yCCBbPsrbo13A252ntWLyNbm.push_vector(wBGU4gk7_tNAq9biq.readDword());
			yCCBbPsrbo13A252ntWLyNbm.push_vector(wBGU4gk7_tNAq9biq.readDword());
			if (RQUG25JPpq2qN.isMyControlObject()) RQUG25JPpq2qN.addSetStatePacket(10, null, STATE_PRIORITY_AUTO, false, "");
			break;
		case 2:
	...
	case 248:
		...
		case 1:
			local Kb6lUKE40cnlRDxhKLRJWmn = sq_GetCNRDObjectToSQRCharacter(RQUG25JPpq2qN.getParent());
			if (Kb6lUKE40cnlRDxhKLRJWmn) Kb6lUKE40cnlRDxhKLRJWmn.getVar().push_obj_vector(RQUG25JPpq2qN);
			sq_ChangeDrawLayer(RQUG25JPpq2qN, ENUM_DRAWLAYER_BOTTOM);
			RQUG25JPpq2qN.getVar().clear_vector();
			local yCCBbPsrbo13A252ntWLyNbm = RQUG25JPpq2qN.getVar();
			yCCBbPsrbo13A252ntWLyNbm.push_vector(wBGU4gk7_tNAq9biq.readDword());
	...
	case 250:
		...
		case 4:
			...
			break;
		case 5:
			local XDyKOZFgVI1zXLT = sq_CreateAnimation("", "passiveobject/chang_qing_skill/priest/animation/holymace/holymaceshockwave_top_dodge.ani");
			RQUG25JPpq2qN.setCurrentAnimation(XDyKOZFgVI1zXLT);
			local wBlSHj6I3y9tynDX3BUk = sq_GetCustomAttackInfo(RQUG25JPpq2qN, 17);
			sq_SetCurrentAttackBonusRate(wBlSHj6I3y9tynDX3BUk, wBGU4gk7_tNAq9biq.readDword());
			sq_SetCurrentAttackInfo(RQUG25JPpq2qN, wBlSHj6I3y9tynDX3BUk);
			break;
		case 6:
			local XDyKOZFgVI1zXLT = sq_CreateAnimation("", "passiveobject/chang_qing_skill/priest/animation/holymace/holymaceshockwave_bot_normal.ani");
			RQUG25JPpq2qN.setCurrentAnimation(XDyKOZFgVI1zXLT);
			local wBlSHj6I3y9tynDX3BUk = sq_GetCustomAttackInfo(RQUG25JPpq2qN, 17);
			sq_SetCurrentAttackBonusRate(wBlSHj6I3y9tynDX3BUk, wBGU4gk7_tNAq9biq.readDword());
			sq_SetCurrentAttackInfo(RQUG25JPpq2qN, wBlSHj6I3y9tynDX3BUk);
			break;
		case 7:
			local XDyKOZFgVI1zXLT = sq_CreateAnimation("", "passiveobject/chang_qing_skill/priest/animation/holymace/holymaceshockwavequakearea_bot_normal.ani");
			local dgsydsaudadddds = wBGU4gk7_tNAq9biq.readDword() / 100.0;
			...
			break;
		case 8:
			local XDyKOZFgVI1zXLT = sq_CreateAnimation("", "passiveobject/new/priest/animation/divineflash/DivineFlash_Multi_Explosion.ani");
			local dgsydsaudadddds = wBGU4gk7_tNAq9biq.readDword() / 100.0;
			XDyKOZFgVI1zXLT.setImageRateFromOriginal(dgsydsaudadddds, dgsydsaudadddds);
			sq_SetAttackBoundingBoxSizeRate(XDyKOZFgVI1zXLT, 1.0, 1.0, 1.0);
			RQUG25JPpq2qN.setCurrentAnimation(XDyKOZFgVI1zXLT);
	...
	case 136:
		...
		case 1:
			...
			if (PUQJpw1BLjMiz0 != 0) RQUG25JPpq2qN.setTimeEvent(0, XDyKOZFgVI1zXLT.getDelaySum(0, 4) / PUQJpw1BLjMiz0, PUQJpw1BLjMiz0 - 1, false);
	...
	case 137:
		...
		case 1:
			...
			if (wBGU4gk7_tNAq9biq.readDword() == 2) esPvN8WgPY = "passiveobject/script_sqr_nut_qq506807329/priest/animation/doomcrush/doomcrush_boom_finish_charge_24.ani";
	...
	case 132:
		...
		case 1:
			...
			case 1:
				XDyKOZFgVI1zXLT = sq_CreateAnimation("", "passiveobject/script_sqr_nut_qq506807329/priest/animation/inviteofdevil/devilinvitation_right_04.ani");
				break;
			case 2:
				XDyKOZFgVI1zXLT = sq_CreateAnimation("", "passiveobject/script_sqr_nut_qq506807329/priest/animation/inviteofdevil/devilinvitation_w_right_03.ani");
				break;
			}
		...
		case 2:
			...
			switch (Zekm4TMtYJZfOxVrbN) {
			case 1:
				XDyKOZFgVI1zXLT = sq_CreateAnimation("", "passiveobject/script_sqr_nut_qq506807329/priest/animation/inviteofdevil/devilinvitation_left_03.ani");
				break;
			case 2:
				XDyKOZFgVI1zXLT = sq_CreateAnimation("", "passiveobject/script_sqr_nut_qq506807329/priest/animation/inviteofdevil/devilinvitation_w_left_04.ani");
				break;
			}
			XDyKOZFgVI1zXLT.setSpeedRate(wBGU4gk7_tNAq9biq.readFloat());
			RQUG25JPpq2qN.setCurrentAnimation(XDyKOZFgVI1zXLT);
